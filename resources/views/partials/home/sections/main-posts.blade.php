                                ...
                                <div class="binduz-er-trending-news-list-box">
                                    ...
                                    <div class="binduz-er-content">
                                        ...
                                        <div class="binduz-er-trending-news-list-title">
                                            <h4 class="binduz-er-title"><a href="{{ route('berita.show', $post->slug) }}">{{ \Illuminate\Support\Str::limit($post->translated('title'), 58) }}</a></h4>
                                            <p>{{ \Illuminate\Support\Str::limit((string) $post->translated('excerpt'), 120) }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @forelse($latestSidebarPosts as $latest)
                            <div class="binduz-er-sidebar-latest-post-item">
                                ...
                                <div class="binduz-er-content">
                                    ...
                                    <h4 class="binduz-er-title"><a href="{{ route('berita.show', $latest->slug) }}">{{ \Illuminate\Support\Str::limit($latest->translated('title'), 46) }}</a></h4>
                                </div>
                            </div>
                        @empty
