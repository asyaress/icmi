...
@section('title', $post->translated('title').' - Opini & Tokoh')
@section('meta_title', $post->translated('seo_title') ?: $post->translated('title').' - Opini & Tokoh')
...
<section class="binduz-er-blog-details-area pb-60 pt-30">
    <div class="container"><div class="row"><div class="col-lg-8">
        <article class="binduz-er-blog-details-box">
            <div class="binduz-er-meta-item mb-2"><div class="binduz-er-meta-categories"><a href="#">{{ optional($post->category)->translated('name') ?? __('ui.pages.opinion.title') }}</a></div><div class="binduz-er-meta-date"><span><i class="fal fa-calendar-alt"></i> {{ optional($post->published_at)->format('d M Y H:i') }}</span></div></div>
