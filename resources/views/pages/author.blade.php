                ...
                <div class=" col-lg-12">
                    <div class="binduz-er-author-box">
                        <div class="binduz-er-thumb">
                            <img src="{{ asset('assets/images/author-user.jpg') }}" alt="">
                            <span>30 Post</span>
                        </div>
            ...
            <div class="row">
                <div class=" col-lg-9">
                    <div class="binduz-er-author-item mb-40">
                        <div class="binduz-er-thumb">
                            <img src="{{ asset('assets/images/author-item-6.jpg') }}" alt="">
                        </div>
                        <div class="binduz-er-content">
                    ...
                    <div class="binduz-er-author-item mb-40">
                        <div class="binduz-er-thumb">
                            <img src="{{ asset('assets/images/author-item-5.jpg') }}" alt="">
                        </div>
                        <div class="binduz-er-content">
                            <div class="binduz-er-meta-item">
                                <div class="binduz-er-meta-categories">
                    ...
                    <div class="binduz-er-author-item mb-40">
                        <div class="binduz-er-thumb">
                            <img src="{{ asset('assets/images/author-item-4.jpg') }}" alt="">
                        </div>
                        <div class="binduz-er-content">
                            <div class="binduz-er-meta-item">
                                <div class="binduz-er-meta-categories">
                    ...
                    <div class="binduz-er-author-item mb-40">
                        <div class="binduz-er-thumb">
                            <img src="{{ asset('assets/images/author-item-3.jpg') }}" alt="">
                        </div>
                        <div class="binduz-er-content">
                            <div class="binduz-er-meta-item">
                                <div class="binduz-er-meta-categories">
                    ...
                    <div class="binduz-er-author-item mb-40">
                        <div class="binduz-er-thumb">
                            <img src="{{ asset('assets/images/author-item-2.jpg') }}" alt="">
                        </div>
                        <div class="binduz-er-content">
                            <div class="binduz-er-meta-item">
                                <div class="binduz-er-meta-categories">
                            ...
                            <h3 class="binduz-er-title"><a href="#">El tiempo vuela en la mayor actualizaciÃ³n de Google Earth en aÃ±os</a></h3>
                            <div class="binduz-er-meta-author">
                                <div class="binduz-er-author">
                                    <img src="{{ asset('assets/images/user-2.jpg') }}" alt="">
                                    <span>By <span>Rosalina D.</span></span>
